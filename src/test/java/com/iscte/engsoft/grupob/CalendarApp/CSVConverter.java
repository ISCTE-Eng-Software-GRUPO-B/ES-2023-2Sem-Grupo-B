...
class CSVConverter {
    ...
    com.iscte.engsoft.grupob.CalendarApp.util.CSVConverter converter = new com.iscte.engsoft.grupob.CalendarApp.util.CSVConverter();

    @Test
    void input_should_be_valid_json_format(){
        Assertions.assertTrue(converter.isValidJSON(content));
    }

    @Test
    void should_convert_from_json_to_csv(){ Assertions.assertNotNull(converter.jsonToCSV(content)); }
}
