...
class CSVConverterTest {
    ...
    @Test
    void inputShouldBeValidJsonFormat(){ Assertions.assertTrue(com.iscte.engsoft.grupob.CalendarApp.util.CSVConverter.isValidJSON(content)); }

    @Test
    void shouldConvertFromJsonToCsv(){ Assertions.assertNotNull(com.iscte.engsoft.grupob.CalendarApp.util.CSVConverter.jsonToCSV(content)); }
}
