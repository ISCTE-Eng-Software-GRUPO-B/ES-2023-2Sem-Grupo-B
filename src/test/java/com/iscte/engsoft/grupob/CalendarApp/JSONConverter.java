...
public class JSONConverter {
    ...
    @Test
    void input_should_be_valid_csv_format(){ Assertions.assertTrue(com.iscte.engsoft.grupob.CalendarApp.util.JSONConverter.isValidCSV(content)); }

    @Test
    void should_convert_from_csv_to_json(){ Assertions.assertNotNull(com.iscte.engsoft.grupob.CalendarApp.util.JSONConverter.csvToJSON(content)); }
}
